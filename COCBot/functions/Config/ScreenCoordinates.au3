...
Global $aCancRequestCCBtn[4] = [340, 470, 0xFDC775, 20] ; Red button Cancel in window request CC
Global $aSendRequestCCBtn[2] = [524, 470] ; Green button Send in window request CC
Global $atxtRequestCCBtn[2] = [335, 385] ; textbox in window request CC
