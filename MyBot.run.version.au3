...
Global $g_sBotVersion = "v7.7.5" ;~ Don't add more here, but below. Version can't be longer than vX.y.z because it is also used in Checkversion()
...
$g_sModversion = "r06" ; MyBot v7.7.5 Light: DEB + DRRTxt + BB Play + Use any siege received + Max Logout Time + Fix Bugs
