...
$hRadio_Army2 = GUICtrlCreateRadio(GetTranslated(621, 38, "Army 12"), $x + 180, $y + 20, 55, 15)
GUICtrlSetState(-1, $GUI_DISABLE)
$hRadio_Army3 = GUICtrlCreateRadio(GetTranslated(621, 39, "Army 123"), $x + 250, $y + 20, 60, 15)
GUICtrlSetState(-1, $GUI_DISABLE)
	$LblRemovecamp = GUICtrlCreateLabel(GetTranslated(621, 41, "Empty Queue"), $x + 340, $y + 20, -1, 15, $SS_LEFT)
...
$txtTotalCampForced = GUICtrlCreateInput("220", $x + 135, $y + 3, 30, 17, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetOnEvent(-1, "SetComboTroopComp")
GUICtrlSetLimit(-1, 3)
...
$y = $yStart + 28
	...
	$y += 280
		...
		$txtTrainLogoutMaxTime = GUICtrlCreateInput("4", $x + 250, $y - 190, 30, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetLimit(-1, 2)
