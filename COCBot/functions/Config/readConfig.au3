...
Func ReadConfig_600_6()
	...
	IniReadS($g_bChkClanGamesSuperTroop, $g_sProfileConfigPath, "other", "ChkClanGamesSuperTroop", False, "Bool")
...
Func ReadConfig_600_11()
	...
	For $i = 0 To 2
		...
		If $g_aiClanCastleTroopWaitType[$i] < $eTroopCount Then ; Barb - Hunt
