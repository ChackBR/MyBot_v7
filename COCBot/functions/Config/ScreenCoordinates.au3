...
Global $aCancRequestCCBtn[4] = [340, 320, 0xFDDC75, 20] ; Red button Cancel in window request CC
Global $aSendRequestCCBtn[2] = [524, 320] ; Green button Send in window request CC
Global $atxtRequestCCBtn[2] = [335, 235] ; textbox in window request CC
