...
Global $aArmyCCRemainTime[2] = [725, 568] ; Training Window Overviewscreen, Minutes & Seconds remaining till can request again
...
Global $aRequestTroopsAO[6] = [758, 584, 0xffffff, 0xb6e45e, 0xC2C2C2, 15] ; Button Request Troops in Army Overview  (x,y,can request, request already made, army full/no clan)
