...
Global $g_sBotVersion = "v7.7.3" ;~ Don't add more here, but below. Version can't be longer than vX.y.z because it is also used in Checkversion()
...
$g_sModversion = "r04" ; MyBot v7.7.3 Light: DEB + DRRTxt + BB Play + Use any siege received + Max Logout Time + Fix Bugs
