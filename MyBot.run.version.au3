...
#pragma compile(FileVersion, 7.8.5)
#pragma compile(LegalCopyright, © https://mybot.run)
#Au3Stripper_On

Global $g_sBotVersion = "v7.8.5" ;~ Don't add more here, but below. Version can't be longer than vX.y.z because it is also used in Checkversion()
...
$g_sModversion = "r01" ; MyBot v7.8.5 Light: DEB + Max Logout Time + BB Loop + June/2020 LSpeel Fix + Dark Drill Costs
