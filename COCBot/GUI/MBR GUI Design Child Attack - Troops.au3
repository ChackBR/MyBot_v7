...
Func CreateTroopsSpellsSubTab()
   ...
   Local $y = 8
	   ...
	   $g_hRdoArmy2 = GUICtrlCreateRadio(GetTranslated(621, 38, "Army 12"), $x + 185, $y + 20, 57, 15)
	   GUICtrlSetState(-1, $GUI_DISABLE)
	   $g_hRdoArmy3 = GUICtrlCreateRadio(GetTranslated(621, 39, "Army 123 + Don't Empty Barracks"), $x + 250, $y + 20, -1, 15)
	   GUICtrlSetState(-1, $GUI_DISABLE)
...
;	Moved down
		GUICtrlCreateLabel(GetTranslated(621, 41, "Remove Army"), $x + 200, $y + 4, -1, 15, $SS_LEFT)
