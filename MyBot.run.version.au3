...
#pragma compile(ProductVersion, 7.8.1)
#pragma compile(FileVersion, 7.8.1)
#pragma compile(LegalCopyright, © https://mybot.run)
#Au3Stripper_On

Global $g_sBotVersion = "v7.8.1" ;~ Don't add more here, but below. Version can't be longer than vX.y.z because it is also used in Checkversion()
...
$g_sModversion = "r02" ; MyBot v7.8.1 Light: DEB + DRRTxt + Max Logout Time + BB Loop + Legends SwitchAccount
