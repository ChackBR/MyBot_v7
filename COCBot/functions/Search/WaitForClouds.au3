...
Func WaitForClouds()
	...
	EndSwitch
	If $debugSetlog Then ; display random values if debug log
...
Func chkSearchText()
	...
	Local $result
	$result = getCloudTextShort(388, 348 + $midOffsetY, "Cloud Search Text: for=", $COLOR_DEBUG, Default) ; OCR "Searching for oponents..." text
